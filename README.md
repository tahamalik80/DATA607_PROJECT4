...
- Data: SpamAssassin public corpus — refer to the SpamAssassin project for usage terms.
- Code: You may reuse the Rmd for coursework or personal projects. If you publish or share the notebook outside the class, include attribution to the original SpamAssassin dataset and any libraries used.
